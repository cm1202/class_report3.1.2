...
void GpoCore :: write_speed(uint16_t led0_speed, uint16_t led1_speed, uint16_t led2_speed,uint16_t led3_speed){
    io_write(base_addr, LED0, led0_speed);
    io_write(base_addr, LED1, led1_speed);
    io_write(base_addr, LED2, led2_speed);
    io_write(base_addr, LED3, led3_speed);
